...
reader.on('line', function(line) {
  ...
  //Writing the JSON file
	fs.writeFileSync('../json/foodgrains.json',JSON.stringify(jArray1,null,'\r\n'),'utf-8');
  fs.writeFileSync('../json/oilseeds.json',JSON.stringify(jArray2,null,'\r\n'),'utf-8');
  fs.writeFileSync('../json/commercial.json',JSON.stringify(jArray3,null,'\r\n'),'utf-8');
  fs.writeFileSync('../json/southernStates.json',JSON.stringify(jArray4,null,'\r\n'),'utf-8');
	obj1={};
  obj1={};
  obj2={};
  obj3={};
